...
lazy_static! {
    pub static ref IUPAC_HASHSET_U8: HashSet<u8> = {
        new_u8_hashset(&IUPAC_U8)
    };
}
lazy_static! {
    pub static ref IUPAC_HASHSET_STR: HashSet<&'static str> = {
        new_str_hashset(&IUPAC_STR)
    };
}
...
lazy_static! {
    pub static ref BASIC_DNA_HASHSET_U8: HashSet<u8> = {
        new_u8_hashset(&BASIC_DNA_U8)
    };
}
lazy_static! {
...
lazy_static! {
    pub static ref BASIC_RNA_HASHSET_U8: HashSet<u8> = {
        new_u8_hashset(&BASIC_RNA_U8)
    };
}
lazy_static! {
