...
// Quality encoding alphabets
// Sections of ASCII Codes are used in different types of quality encodings. Here, each encoding's possible characters are placed into a type of 'alphabet', which can then be searched against for technically illegal or unknown characters. 
// Three encodings included: Phred33, Phred64, and Sanger. Note that Sanger quality alphabet includes 33-126, or all 'printable' ASCII, and covers both other quality character alphabets and more.
//
// ASCII Codes:
...
// Quality Scores in Phred33, Phred64, and Sanger
// phred33:	Range 	Offset 	Type 	Range 
// Sanger standard 	 	 	 	 
...
// Phred33
const Phred33: [u8; 4] = [b'A', b'C', b'G', b'U'];
