...
//         vec.push(*BASIC_DNA_U8.choose(&mut rng)?)
//     }
//     vec
// }
...
//     let mut vec = Vec::with_capacity(nbases);
//     for _base in 0..nbases {
//         vec.push(*BASIC_RNA_U8.choose(&mut rng)?)
//     }
//     vec
// }
...
//     let mut vec = Vec::with_capacity(nbases);
//     for _base in 0..nbases {
//         vec.push(*BASIC_AMINO_ACID_U8.choose(&mut rng)?)
//     }
//     vec
// }
...
//     let mut vec = Vec::with_capacity(nbases);
//     for _base in 0..nbases {
//         vec.push(*PHRED33_U8.choose(&mut rng)?)}
//     vec
// }
...
//     let mut vec = Vec::with_capacity(nbases);
//     for _base in 0..nbases {
//         vec.push(*PHRED64_U8.choose(&mut rng)?)}
//     vec
// }
