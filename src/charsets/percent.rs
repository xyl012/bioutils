...
pub const PERCENT_SLICE: & [u8] = &PERCENT;
pub const PERCENT_USIZE_SLICE: & [usize] = &PERCENT_USIZE;
pub const PERCENT_U64_SLICE: & [u64] = &PERCENT_U64;
...
impl PercentCharSet {
    pub const fn value(&self) -> &[u8] {
        match *self {
            PercentCharSet::Percent => PERCENT_SLICE,
        }
    }
}
...
impl PercentUsizeCharSet {
    pub const fn value(&self) -> &[usize] {
        match *self {
            PercentUsizeCharSet::Percent => PERCENT_USIZE_SLICE,
        }
    }
}
...
impl PercentU64CharSet {
    pub const fn value(&self) -> &[u64] {
        match *self {
            PercentU64CharSet::Percent => PERCENT_U64_SLICE,
        }
    }
}
