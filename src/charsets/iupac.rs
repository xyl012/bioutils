...
/// b'A' is 65, so here it's T,
/// b'C' is 67, so here it's G,
/// b'G' is 71, so here it's C,
/// b'T' is 84, so here it's A, 
/// b'N' is 78, so here it's N,
pub const DNA_COMPLEMENT_DECODE: [u8;85] = [
