...
/// Filler for non-coding values in dna complementing, chosen because the value is not part of the set
pub const COMPLEMENT_FILLER: u8 = 255;
...
/// b'T' is 84= A, 
/// b'N' is 78= N,
pub const DNA_COMPLEMENT: [u8;85] = [
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    ...
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    b'T', COMPLEMENT_FILLER, b'G', COMPLEMENT_FILLER, COMPLEMENT_FILLER, 
    COMPLEMENT_FILLER, b'C', COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'N', COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'A',
];

// AaCcTtGgNn
// [65, 97, 67, 99, 84, 116, 71, 103, 78, 110]
/// b'A' is 65 = T,
/// b'a' is 97 = t,
/// b'C' is 67 = G,
/// b'c' is 99 = g,
...
pub const DNA_COMPLEMENT_MIX_CASE: [u8;117] = [
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    ...
    COMPLEMENT_FILLER, b'C', COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'N', COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'A', COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, b't', COMPLEMENT_FILLER, b'g', COMPLEMENT_FILLER, // 100

    COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'a', COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, b'n',
    COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER, COMPLEMENT_FILLER,
    b'c',
