...
pub const IUPAC_HASHSET_U8: HashSet<u8> = new_u8_hashset(&IUPAC_U8);
pub const IUPAC_HASHSET_STR: HashSet<&str> = new_str_hashset(&IUPAC_STR);
...
pub const IUPAC_NUCLEOTIDE_HASHSET_U8: HashSet<u8> = new_u8_hashset(&IUPAC_NUCLEOTIDE_U8);
pub const IUPAC_NUCLEOTIDE_HASHSET_STR: HashSet<&str> = new_str_hashset(&IUPAC_NUCLEOTIDE_STR);
...
pub const IUPAC_AMINO_ACID_HASHSET_U8: HashSet<u8> = new_u8_hashset(&IUPAC_AMINO_ACID_U8);
pub const IUPAC_AMINO_ACID_HASHSET_STR: HashSet<&str> = new_str_hashset(&IUPAC_AMINO_ACID_STR);

// Basic DNA charset
pub const BASIC_DNA_U8: [u8; 4] = [b'A', b'C', b'G', b'T'];
pub const BASIC_DNA_STR: [&str; 4] = ["A", "C", "G", "T"];
pub const BASIC_DNA_HASHSET_U8: HashSet<u8> = new_u8_hashset(&BASIC_DNA_U8);
pub const BASIC_DNA_HASHSET_STR: HashSet<&str> = new_str_hashset(&BASIC_DNA_STR);

// Basic RNA charset
pub const BASIC_RNA_U8: [u8; 4] = [b'A', b'C', b'G', b'U'];
pub const BASIC_RNA_STR: [&str; 4] = ["A", "C", "G", "U"];
pub const BASIC_RNA_HASHSET_U8: HashSet<u8> = new_u8_hashset(&BASIC_RNA_U8);
pub const BASIC_RNA_HASHSET_STR: HashSet<&str> = new_str_hashset(&BASIC_RNA_STR);
...
pub const BASIC_AMINO_ACID_HASHSET_U8: HashSet<u8> = new_u8_hashset(&BASIC_AMINO_ACID_U8);
pub const BASIC_AMINO_ACID_HASHSET_STR: HashSet<&str> = new_str_hashset(&BASIC_AMINO_ACID_STR);
