...
pub fn download_grch38_primary_assembly_genome_fa_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_primary_assembly_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_basic_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_chr_patch_hapl_scaff_annotation_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_chr_patch_hapl_scaff_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_chr_patch_hapl_scaff_basic_annotation_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_chr_patch_hapl_scaff_basic_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_lncrna_transcripts_fa_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_long_noncoding_rnas_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_long_noncoding_rnas_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_annotation_remark_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_entrezgene_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_exon_supporting_feature_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_swissprot_gz(output_directory: &str) {
    let regex: &str = r"gencode.v\d{2}.metadata.SwissProt.gz";
    download_reference_file(regex, &HUMAN_RELEASE_DIRECTORY, output_directory);
}

/// Downloads the latest version of gencode.vxx.metadata.TrEMBL.gz
pub fn download_gencode_vxx_metadata_trembl_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_transcript_source_gz(output_directory: &str) {
...
pub fn download_gencode_vxx_metadata_transcript_supporting_feature_gz(output_directory: &str) {
...
pub fn download_grcm39_primary_assembly_genome_fa_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_primary_assembly_annotation_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_basic_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_chr_patch_hapl_scaff_annotation_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_chr_patch_hapl_scaff_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_chr_patch_hapl_scaff_basic_annotation_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_chr_patch_hapl_scaff_basic_annotation_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_lncrna_transcripts_fa_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_long_noncoding_rnas_gff3_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_long_noncoding_rnas_gtf_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_annotation_remark_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_entrezgene_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_exon_supporting_feature_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_pubmed_id_gz(output_directory: &str) {
    let regex: &str = r"gencode.vM\d{2}.metadata.Pubmed_id.gz";
    download_reference_file(regex, &MOUSE_RELEASE_DIRECTORY, output_directory);
}

/// Downloads the latest version of gencode.vMxx.metadata.RefSeq.gz
pub fn download_gencode_vmxx_metadata_refseq_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_selenocysteine_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_swissprot_gz(output_directory: &str) {
    let regex: &str = r"gencode.vM\d{2}.metadata.SwissProt.gz";
    download_reference_file(regex, &MOUSE_RELEASE_DIRECTORY, output_directory);
}

/// Downloads the latest version of gencode.vMxx.metadata.TrEMBL.gz
pub fn download_gencode_vmxx_metadata_trembl_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_transcript_source_gz(output_directory: &str) {
...
pub fn download_gencode_vmxx_metadata_transcript_supporting_feature_gz(output_directory: &str) {
