...
fn main()-> std::io::Result<()>{
    ...
    let fastq_ftp = "ftp://ftp.sra.ebi.ac.uk/vol1/run/ERR438/ERR4387386/";
    let fq1_gz = "P17157_1016_S16_L001_R1_001.fastq.gz";
    let fq2_gz = "P17157_1016_S16_L001_R2_001.fastq.gz";
    ...
    let filtered_read_names = bioutils::files::fastq::hash::find_paired_fastq_reads(test_reader, test_reader2);
